			...
			<div class="card-body">
				...
				<form method="POST" action="/producto" accept-charset="UTF-8" style="display:inline">
					...
					<div class="form-group">
						...
						{!!$errors->first('f003_imei',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_imei')}}</small>
                    </div>
					<div class="form-group">
						...
						{!!$errors->first('f003_referencia',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_referencia')}}</small>
                    </div>
                    ...
                    <div class="form-group">
						...
						{!!$errors->first('f003_precio_compra',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_precio_compra')}}</small>
                    </div>
                    ...
                    <div class="form-group">
						...
						{!!$errors->first('f003_precio_venta',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_precio_venta')}}</small>
					</div>
					
					<div class="form-group">
						<label for="producto">Iva</label>
						<input type="double" class="form-control" name="f003_iva" id="f003_iva" value ={{old('f003_iva')}}>
						{!!$errors->first('f003_iva',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_iva')}}</small>
                    </div>
                    ...
                    <div class="form-group">
						...
						{!!$errors->first('f003_descuento',)!!}
						<small id="productolHelp" class="form-text text-muted">{{$errors->first('f003_descuento')}}</small>
                    </div>
